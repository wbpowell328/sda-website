...
<img src="/sda-website/assets/images/what-is-rl/Stochastic-optimization-terms-1-300x203.jpg" alt="A bar chart comparing the relative number of Google Scholar citations across major terms in stochastic optimization for the years 2010, 2015, and 2020, with 'reinforcement learning' showing dramatic growth from 2015 to 2020 and 'stochastic optimization' also growing quickly" width="300" align="right" style="max-width: 100%; height: auto; margin-left: 1rem; margin-bottom: 0.5rem;" />
