...
I have been accumulating a number of links to pages on "sequential decision![](/sda-website/assets/images/sdalinks/RLSO-cover.jpg) analytics" and my new book, *Reinforcement Learning and Stochastic Optimization*.  Also, I have been using "tinyurl" links because they are easier to remember (and I can track traffic), but not everyone can use these links.  This page will list the most interesting resources, including both the "tinyurl" link and the original link.  Please use the "tinyurl" link if you can, so I can see which links are attracting the most interest.  
...
- Fundamental to sequential decision problems is understanding precisely what is meant by a "decision."  [I prepared a new webpage called "What is a decision" - just click here.](https://tinyurl.com/whatisadecision/)  

## ![](/sda-website/assets/images/sdalinks/Bridging-Vol-I-cover.jpg)
...
- ![](/sda-website/assets/images/sdalinks/SDAM-front-cover.jpg)If you are ready for a little math, start by viewing [part 3 of the "framing" video above.](https://tinyurl.com/PowellFramingVideo/) I then recommend downloading the introductory book "[Sequential Decision Analytics and Modeling](https://tinyurl.com/sdamodeling/)" which uses a teach-by-example style.  With the exception of chapters 1 and 7, each chapter uses a different example to illustrate the universal modeling framework, along with all four classes of policies.  
- For professors looking to teach an undergraduate or masterscourse on this topic, these two books would make a nice combination.  Encourage students to come up with their own examples of sequential decision problems.  They can either just perform framing or, if they have some math skills, they can model their problem following the style of the SDAM book.
- I prepared a webpage where you can access a talk I gave in April, 2025 to Cornell's ORIE department on a fresh approach to teaching optimization.  The presentation challenges how I think we should approach the contributions of George Dantzig and Richard Bellman:
  ...
  Original link: [/sda-website/howtoteachoptimization/](/sda-website/howtoteachoptimization/)
...
Original link: </sda-website/powelltoyotavideo/>
...
Tinyurl link: <https://tinyurl.com/HowtoTeachOptimization/>
Original link: </sda-website/howtoteachoptimization/>
...
![](/sda-website/assets/images/sdalinks/Bridging-Vol-I-cover.jpg)This is a series of monographs on sequential decision problems, starting with Volume I: Framing the Problem.  This book has no math and instead focuses on the initial step of framing a problem, which starts with identifying performance metrics, types of decisions, and forms of uncertainty.  
...
Original link: [/sda-website/sdamodeling/![](/sda-website/assets/images/sdalinks/SDAM-outline.jpg)](/sda-website/sdamodeling/)
...
![](/sda-website/assets/images/sdalinks/RLSO-cover.jpg)
...
Original link: [/sda-website/teachingoptimization/![](/sda-website/assets/images/sdalinks/Modern-Approach-to-Teaching-Optimization.gif)](/sda-website/teachingoptimization/)

## **Introduction to optimal learning:**

## **![](/sda-website/assets/images/sdalinks/optimal-learning-cover.jpg)**
...
- [A short video introduction illustrating two simple learning policies](https://tinyurl.com/LearningWhileDoing/) that I call "Learning While Doing."
- [A link to my undergraduate course at Princeton, "Optimal Learning"](/sda-website/optimallearningcourse/) - Includes a link to an unfinished second edition of my book, along with my lecture slides in PowerPoint. 
- [A link to a webpage on the knowledge gradient](https://tinyurl.com/knowledgegradient/), a powerful learning policy for noisy, expensive experiments.  The knowledge gradient policy won the "Test of Time" award from the Informs Journal on Computing, which published the early papers on this topic.
- [More resources on optimal learning is available here](https://tinyurl.com/PowellOptimalLearning/).
- Optimal learning is particularly useful for experimental scientists working in a lab.  I spent 5 years working on a large grant for the Air Force on optimal learning in materials science, which produced a [tutorial article on optimal learning in materials science](https://arxiv.org/abs/2004.05417), and a [webpage with information specifically geared to this problem class](https://optimallearning.princeton.edu/tutorialsciences.htm).

## **Courses and teaching materials:**

I have prepared a webpage dedicated to different ways for teaching sequential decision analytics (January, 2026).  

Tinyurl link: [https://tinyurl.com/TeachingSDA/](https://tinyurl.com/RLSOcourses/)
Original link: </sda-website/teachingsda/>
...
Tinyurl link: <https://tinyurl.com/TeachingOpt>
Original link: </sda-website/teachingoptimization/>
...
Original link: </sda-website/assets/slides/Powell-From-static-to-sequential-MILP-July-2025.pptx>

![](/sda-website/assets/images/sdalinks/From-optimization-to-policies.jpg)
...
Original link: </sda-website/statevariables/>
...
Original link: </sda-website/sdalanguages/>
...
Original link: </sda-website/what-is-rl/>
...
Original link: </sda-website/rlvssda/>
