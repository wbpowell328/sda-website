...
{% raw %}
This webpage is designed to help you design teaching material for courses in sequential decision analytics. This material is suitable for a wide range of audiences:

- Masters (MSE and MBA) and undergraduate - I suggest the companion book [Sequential Decision Analytics and Modeling](https://tinyurl.com/sdamodeling/) (SDAM) which uses a teach-by-example style.
- Graduate level - For students who want to actually build models and design algorithms for solving the models, I suggest my graduate level book [Reinforcement Learning and Stochastic Optimization: A unified framework for sequential decisions](https://tinyurl.com/RLandSO) (RLSO).
- Professional groups in industry - Many companies have analytics (today often grouped under "data analytics") of people with an interest in mathematical models and algorithms.
- In April, 2025 I gave a talk at Cornell's ORIE department on a fresh approach to teaching optimization.  [I have broken this talk into four parts here](https://tinyurl.com/HowtoTeachOptimization/). 

I can envision several ways to teach this material: 

**Weekly seminars** - These are for students or professionals who want to teach this material to themselves.  This can easily done with groups of as little as four or five people in the format of a weekly seminar.  There are two levels at which this can be done:

- **Introductory seminar** - This is for undergraduates and masters as well as Ph.D.s and professionals whose primary focus is in a problem domain (rather than theory).
- **Advanced seminar** - This is for students and professionals who want to learn the technical material in RLSO.  This is particularly important for people who want to develop the software behind the models and algorithms for describing and solving sequential decision problems.

I recently developed a new way of teaching introduction to optimization:

- **A Modern Approach to Teaching Optimization** - This introductory course (undergraduates and masters) transitions through a sequence of basic machine learning problems, then to a succession of relatively simple sequential decision problems, and closes with linear, integer, and nonlinear programming, which are taught as both static and sequential problems.  See <https://tinyurl.com/TeachingOpt/> for an overview and detailed teaching notes.
...
- A graduate course (masters to Ph.D.) for a broad audience from engineering and the sciences. My graduate course at Princeton was attended by students from eight different departments.

Other ideas for teaching this material:

- 2-4 lectures within an existing course focusing on a problem domain.
- Teaching sequential decision analytics to MBAs - For the more complex problems that arise in business, it is important to start with problem identification by answering three key questions (about metrics, decisions and uncertainties) that are a prerequisite for forming a model, even if the students are never going to write a line of code.

If you are interested in joining the community of people interested in teaching this material (in whatever format fits you) [please sign up here](https://tinyurl.com/rlsocoursesignup).

### Weekly seminar series (introductory)

The idea of this weekly seminar series is to focus on developing the process of modeling in the context of actual applications.  I recommend following the style of the application chapters (every chapter except chapters 1 and 7) in *[Sequential Decision Analytics and Modeling](https://tinyurl.com/sdamodeling/) (SDAM). * You can download the book [*here*](https://tinyurl.com/PowellSDAMbook/). 

- Week 1 - I suggest starting by listing as many sequential decision problems as you can that are relevant to the people attending the seminar.  One way to get started is to ask everyone attending the seminar to come with several examples of decision problems that they can think of.  I then also suggest working through chapter 1 of SDAM to illustrate the notation in the context of the inventory problems in section 1.3.
- Weeks 2-6 - You can either use each week to present chapters 2-6, or use these weeks to follow the format of these chapters to model decision problems from applications familiar to the group attending.  I recommend focusing on the simpler decision problems.  As I do in the book, make sure that you always start by modeling a relatively simple version of your problem, and then in whatever time is remaining, suggest extensions and model these.
- Week 7 - I recommend using this week to follow the outline of Chapter 7, which reviews materials from the first six weeks.  Note that I illustrate the different state variables, and also review each of the policies used to solve the applications in the first six weeks.
...
### Weekly seminar series (advanced)

I believe this material is so important that graduate students and analytics professionals who do not have access to a course that teaches this material may want to run a seminar on their own.  Typically this would involve a weekly meeting of about 60-90 minutes.  I suggest the following topics:
...
### Undergraduate/masters course in optimization

I think the basic courses that are taught in "optimization," with their traditional emphasis on linear programming and extensions, are misguided.  An optimization course should address the science of making the best possible decisions - any decisions.

I have prepared a detailed design of an introductory course in optimization that blends machine learning, sequential decision problems, and then linear, integer and nonlinear programming where I present both static formulations, which are then extended to sequential problems.

Go to the webpage

<https://tinyurl.com/TeachingOpt>

There is a downloaded document (in both MS Word and pdf formats) that provide all the details.
...
[Download syllabus here](https://castle.princeton.edu/wp-content/uploads/2023/04/ORF_544_S2019-syllabus_Jan2019.pdf).

**Readings:**

This course is designed to be taught from my book: [*Reinforcement Learning and Stochastic Optimization: A unified framework for sequential decisions*](https://tinyurl.com/RLandSO/).  It is 1100 pages, and the print version is in black&white.  The e-book version is much easier to use.  If you prefer a printed version, there are websites that offer printing services as low as \$0.05 per page, and can be ordered in 3-hole punch format.
...
[Midterm exam](https://castle.princeton.edu/wp-content/uploads/2023/04/ORF-544-midterm-2019.pdf) - I primarily used the "review questions" at the end of chapters 1-7.
[Final exam](https://castle.princeton.edu/wp-content/uploads/2023/04/ORF-544-final-exam-2019.pdf) - I primarily used the "review questions" at the end of chapters 8-19.

**Lectures:** 

Below are the lectures from the course I taught Spring, 2019.  Each lecture is given in pdf and powerpoint formats.

Week 1 - Introduction and overview ([pdf](https://castle.princeton.edu/wp-content/uploads/2022/04/ORF-544-Week-1-Introduction-and-overview.pdf)) ([powerpoint](https://castle.princeton.edu/wp-content/uploads/2022/04/ORF-544-Week-1-Introduction-and-overview.pptx))

Week 2 - Adaptive learning ([pdf](https://castle.princeton.edu/wp-content/uploads/2022/04/ORF-544-Week-3-Derivative-based-stochastic-optimization.pdf)) ([powerpoint](https://castle.princeton.edu/wp-content/uploads/2022/04/ORF-544-Week-2-Adaptive-learning.pptx))

Week 3 - Derivative-based stochastic optimization (pdf) ([powerpoint](https://castle.princeton.edu/wp-content/uploads/2022/04/ORF-544-Week-3-Derivative-based-stochastic-optimization.pptx))

[Week 3 - (by post-doc Saeed Ghadimi) - Stochastic-based stochastic search for nonconvex problems (pdf)](https://castle.princeton.edu/wp-content/uploads/2019/02/Ghadimi-Stochastic-optimization-for-nonconvex-problems-Feb-25.pdf)

Week 4 - Derivative-free stochastic optimization Part I: PFAs and CFAs ([pdf](https://castle.princeton.edu/wp-content/uploads/2022/04/ORF-544-Week-4-Derivative-free-stochastic-optimization.pdf)) ([powerpoint](https://castle.princeton.edu/wp-content/uploads/2022/04/ORF-544-Week-4-Derivative-free-stochastic-optimization.pptx))

Week 5 - Derivative-free stochastic optimization Part II: VFAs and DLAs ([pdf](https://castle.princeton.edu/wp-content/uploads/2022/04/ORF-544-Week-5-Derivative-free-stochastic-optimization-VFA-and-DLA.pdf)) ([powerpoint](https://castle.princeton.edu/wp-content/uploads/2022/04/ORF-544-Week-5-Derivative-free-stochastic-optimization-VFA-and-DLA.pptx))

Week 6 - Notation and the unified modeling framework ([pdf](https://castle.princeton.edu/wp-content/uploads/2022/04/ORF-544-Week-6-Modeling-The-unified-framework.pdf)) ([powerpoint](https://castle.princeton.edu/wp-content/uploads/2022/04/ORF-544-Week-6-Modeling-The-unified-framework.pptx))

Week 7 - Uncertainty and designing policies ([pdf](https://castle.princeton.edu/wp-content/uploads/2022/04/ORF-544-Week-7-Uncertainty-and-designing-policies.pdf)) [(](https://castle.princeton.edu/wp-content/uploads/2019/03/ORF-544-Week-7-Uncertainty-and-designing-policies.pptx)[powerpoint](https://castle.princeton.edu/wp-content/uploads/2022/04/ORF-544-Week-7-Uncertainty-and-designing-policies.pptx)[)](https://castle.princeton.edu/wp-content/uploads/2019/03/ORF-544-Week-7-Uncertainty-and-designing-policies.pptx)

Week 8 - Policy function approximations (PFAs) and policy search ([pdf](https://castle.princeton.edu/wp-content/uploads/2022/04/ORF-544-Week-8-PFAs-and-policy-search.pdf)) [(](https://castle.princeton.edu/wp-content/uploads/2019/04/ORF-544-Week-8-PFAs-and-policy-search.pptx)[powerpoint](https://castle.princeton.edu/wp-content/uploads/2022/04/ORF-544-Week-8-PFAs-and-policy-search.pptx)[)](https://castle.princeton.edu/wp-content/uploads/2019/04/ORF-544-Week-8-PFAs-and-policy-search.pptx)

Week 9 - Cost function approximations (CFAs) and introduction to Markov decision processes ([pdf](https://castle.princeton.edu/wp-content/uploads/2022/04/ORF-544-Week-9-CFAs-and-intro-to-MDP.pdf)) ([powerpoint](https://castle.princeton.edu/wp-content/uploads/2022/04/ORF-544-Week-9-CFAs-and-intro-to-MDP.pptx))

Week 10 - Approximate dynamic programming and Q-learning (VFAs) ([pdf](https://castle.princeton.edu/wp-content/uploads/2022/04/ORF-544-Week-10-Approximate-dynamic-prograrmming-and-Q-learning.pdf)) ([powerpoint](https://castle.princeton.edu/wp-content/uploads/2022/04/ORF-544-Week-10-Approximate-dynamic-prograrmming-and-Q-learning.pptx))

Week 11 - Approximate dynamic programming - Monotonicity and convexity ([pdf](https://castle.princeton.edu/wp-content/uploads/2022/04/ORF-544-Week-11-Approximate-dynamic-prograrmming-Monotonicity-and-convexity.pdf)) ([powerpoint](https://castle.princeton.edu/wp-content/uploads/2022/04/ORF-544-Week-11-Approximate-dynamic-prograrmming-Monotonicity-and-convexity.pptx))

Week 12 - Lookahead policies ([pdf](https://castle.princeton.edu/wp-content/uploads/2022/04/ORF-544-Week-12-Lookahead-policies.pdf)) ([powerpoint](https://castle.princeton.edu/wp-content/uploads/2022/04/ORF-544-Week-12-Lookahead-policies.pptx))
...
### Teaching sequential decision analytics to MBAs
...
Finally, for organizations with multiple decision makers (as occurs in virtually any business), designing metrics for different decision makers is a rich topic of discussion.

I illustrate this idea of starting with the answers to these three questions and relating it to my framework in a talk I gave to a group of supply chain executives - [click here for a link to a video of the talk](https://tinyurl.com/SDAforSCMvideoexecutive).

Once these questions are answered, you can start introducing the analytic notation for the five components of a sequential decision problem.  Note that there is no real theory here - it is just assigning variable names to the different components.  I recommend accompanying the analytical model with a spreadsheet (for simpler problems) to make the point that any spreadsheet can be translated to an analytical model - analytics is just a language.  But spreadsheets have limitations, and software of any form can be hard to read if you want to understand relationships.

You can follow the style I use in the book chapters, but adapt the presentation to your own business problems.
{% endraw %}
