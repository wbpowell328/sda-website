...
- [Driver fleet planning at Schneider National](/schneider/) - The "tactical planning system" as![](https://castle.princeton.edu/wp-content/uploads/2022/02/schneider_dispatch_room-300x225.jpg) they call it uses approximate dynamic programming to intelligently model the behavior of dispatchers, allowing Schneider to change the mix of drivers and freight, or to test changes in work rules and driver management policies.
