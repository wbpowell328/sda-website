...
Optimal Learning for Drug Discovery in Ewing's Sarcoma — Diana Negoescu, Informs presentation, October 2009.

**Additional readings:**

Diana Negoescu, Peter I. Frazier, "Optimal Learning for Drug Discovery in Ewing's Sarcoma," paper submitted to the "Doing Good with Good OR" competition of Informs.

Diana Negoescu, Peter I. Frazier and Warren B. Powell, "The Knowledge-Gradient Algorithm for Sequencing Experiments in Drug Discovery" — a more complete technical paper describing the algorithmic research in detail, with a separate technical appendix.

Frazier, P., W. B. Powell and S. Dayanik, "A Knowledge Gradient Policy for Sequential Information Collection," *SIAM J. on Control and Optimization*, Vol. 47, No. 5, pp. 2410-2439 (2008). — the original theory paper setting up the knowledge gradient algorithm with independent beliefs.

P. Frazier, W. B. Powell, S. Dayanik, "The Knowledge-Gradient Policy for Correlated Normal Beliefs," *Informs Journal on Computing*. — introduces the knowledge gradient algorithm for correlated beliefs. Limited to problems where the number of potential alternatives to measure is not too large (say, < 1000).
{% endraw %}
