...
<img src="/assets/images/whatisadecision/run-a-better-anything.jpg" alt="If you want to run a better supply chain, energy system, health system, business process, transportation system, ... anything — you have to make better decisions." style="display: block; margin: 1.5rem auto; max-width: 72%; height: auto;" />
