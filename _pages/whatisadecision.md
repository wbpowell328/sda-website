...
10. **Deciding what to decide** - In most real applications, the number of potential decisions (that is, anywhere we face a choice) can be quite large.  We have to prioritize which decisions have the greatest economic value to justify doing any formal analysis.  I describe a simple approach for "deciding what to decide" in [part 2 of the framing tutorial here](https://www.youtube.com/watch?v=3cpwSLbjjm4&feature=youtu.be).   
