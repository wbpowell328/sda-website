...
<img src="/sda-website/assets/images/the-7-levels-of-ai/7levelsofAI2026.png" alt="The 7 levels of AI infographic: Level 7 'Integrated LLMs and decisions' at the top (Next gen AI, Advanced behaviors and planning), Levels 5–6 grouped as Optimization (Sequential decision problems, Deterministic optimization), Levels 2–4 grouped as Machine learning (Large language models, Pattern recognition, Basic machine learning), and Level 1 'Rule-based logic' at the bottom (Simple behaviors)" width="829" style="display: block; margin: 1.5rem auto; max-width: 100%; height: auto;" />
...
<img src="/sda-website/assets/images/the-7-levels-of-ai/7levelsofAI2-300x238.jpg" alt="A sigmoid demand curve fit through scattered data points labeled 'Training data' — a stylized illustration of regression / supervised learning" width="240" align="right" style="max-width: 100%; height: auto; margin-left: 1rem; margin-bottom: 0.5rem;" />
...
<img src="/sda-website/assets/images/the-7-levels-of-ai/7levelsofAI3-300x300.jpg" alt="A sunflower photograph with a square inset showing the magnified pixel detail of its center — illustrating image / pattern recognition" width="204" align="right" style="max-width: 100%; height: auto; margin-left: 1rem; margin-bottom: 0.5rem;" />
...
<img src="/sda-website/assets/images/the-7-levels-of-ai/7levelsofAI4-251x300.jpg" alt="Screenshot of a ChatGPT conversation: the user asks for a metaphor explaining chatGPT to stock-market investors, and ChatGPT responds with a financial-advisor analogy" width="220" align="right" style="max-width: 100%; height: auto; margin-left: 1rem; margin-bottom: 0.5rem;" />
...
<img src="/sda-website/assets/images/the-7-levels-of-ai/7levelsofAI5-300x78.jpg" alt="NBC News headline strip: 'ChatGPT is powered by these contractors making $15 an hour' by David Ingram" width="540" style="display: block; margin: 1.5rem auto; max-width: 100%; height: auto;" />
...
<img src="/sda-website/assets/images/the-7-levels-of-ai/7levelsofAI4a-246x300.jpg" alt="A canonical linear program: minimize cx subject to Ax = b, x ≥ 0 — the prototypical deterministic-optimization model" width="220" align="right" style="max-width: 100%; height: auto; margin-left: 1rem; margin-bottom: 0.5rem;" />
...
<img src="/sda-website/assets/images/the-7-levels-of-ai/7levelsofAI6-300x114.jpg" alt="The sequential decision objective: max over π of E [ Σ from t=0 to T of C(S_t, X^π(S_t)) | S_0 ]" width="320" align="right" style="max-width: 100%; height: auto; margin-left: 1rem; margin-bottom: 0.5rem;" />
...
<img src="/sda-website/assets/images/the-7-levels-of-ai/7levelsofAI8.jpg" alt="Side-by-side comparison of machine learning (searching over functions to fit a training dataset) and sequential decisions (searching over policies plus a system model), with a list of policy classes on the right" width="840" style="display: block; margin: 1.5rem auto; max-width: 100%; height: auto;" />
...
a.  Getting the data into the model.
b.  Accurately representing the physics of the problem.
c.  Communicating the results to the field so they can be implemented.
...
<img src="/sda-website/assets/images/the-7-levels-of-ai/DNAS-graph.png" alt="Decision-native agentic systems (DNAS) diagram: data flows from the field (boxes, people, robots, trucks, factories with LLM helpers) through estimate/forecast ML modules into a central data repository, then through three Policy X^π(S_t) modules producing production plans, inventory orders, and facility locations communicated back to the field. Labeled at the bottom: Information ingestion and estimation agents, Decision agents, Implementation agents" width="900" style="display: block; margin: 1.5rem auto; max-width: 100%; height: auto;" />
