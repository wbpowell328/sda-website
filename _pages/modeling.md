...
<img src="/assets/images/modeling/problem-to-software-flow.png" alt="A flow diagram: 'From problem...' (trucks, vaccines, phones, boxes) → '...to mathematical model...' (a mathematical modeler with notation Min E[cx] subject to Ax=b, x≥0) → '...to software' (a developer at a computer)" style="display: block; margin: 1rem auto; max-width: 100%; height: auto;" />
...
<img src="/assets/images/modeling/blind-men-elephant.png" alt="The classic 'blind men and the elephant' cartoon — six experts touching different parts of an elephant and each calling it a fan, a wall, a rope, a spear, a snake, or a tree" width="480" align="right" style="max-width: 100%; height: auto; margin-left: 1rem; margin-bottom: 0.5rem;" />
