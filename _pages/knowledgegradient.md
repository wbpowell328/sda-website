...
- [**Test of Time Award Citation**](#award) — Peter Frazier's 2025 INFORMS Test of Time Award for *The Knowledge-Gradient Policy for Correlated Normal Beliefs*.
...
Peter Frazier prepared a retrospective of the knowledge gradient, which summarizes the body of research that followed the publication of the knowledge gradient ([Click here)](https://castle.princeton.edu/wp-content/uploads/2026/02/Frazier-retrospective-of-KG-Dec-2025.pdf).
...
## Learning while doing video {#video}
